...
FULL_PATH=~/vin_logs/$timestamp.txt
    ...
    ./../Stereo-Inertial/stereo_inertial_pear ../../Vocabulary/ORBvoc.txt ../Stereo-Inertial/orbslam3_stereo_inertial.yaml /dev/ttyACM0 /dev/ttyAMA0 1500000 2 0 --autogain-on-lost >> $FULL_PATH 2>&1
